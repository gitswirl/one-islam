export const apiArray = [
  ...
  },
  {
    ...
    verses: [
      ...
      "Jeśli boli was jakaś rana, to podobna rana boli innych ludzi. Takie dni zmieniamy kolejno wśród ludzi, żeby Bóg poznał tych, którzy wierzą, i wziął spośród was świadków - a Bóg nie kocha ludzi niesprawiedliwych â",
  ...
  },
  {
    ...
    verses: [
      ...
      'Oni przeznaczają Bogu pewną część z tego, co On sprawił, iż wyrosło - z plonów pola i z trzód. Â­ I mówią: "To jest dla Boga! - tak oni twierdzą, Â­ a to jest dla naszych współtowarzyszy!" Lecz to, co jest dla ich współtowarzyszy, nie dochodzi do Boga; a to, co jest przeznaczone dla Boga, dochodzi do ich współtowarzyszy. Jakże złe jest ich rozumowanie',
  ...
  },
  {
    ...
    verses: [
      ...
      'Zapisz nam to, co jest piękne w życiu na tym świecie i w życiu ostatecznym! âOto nawróciliśmy się ku Tobie!" Powiedział: "Ja dosięgam Moją karą, kogo chcę, a Moje miłosierdzie obejmuje każdą rzecz. Ja zapiszę to tym, którzy są bogobojni, tym, którzy dają jałmużnę, tym, którzy wierzą w Nasze znaki',
