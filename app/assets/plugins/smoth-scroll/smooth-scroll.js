var behaviour = {
    // Scrolling Core
    frameRate: -50, // [Hz]
    animationTime: 800, // [ms] trasition of scroll effect
    stepSize: 110, // [px]  pixels to moveUp when scroll up & move down when scroll down
    ...
    arrowScroll: 110, // [px]  px move up down on kwboard up down arow ke pressed
...
(function() {
    ...
    function isTouchpad(deltaY) {
        ...
        var tp = !allDeltasDivisableBy(120) &&
